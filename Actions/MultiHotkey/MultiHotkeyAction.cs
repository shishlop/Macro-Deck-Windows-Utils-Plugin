...
public class MultiHotkeyAction : PluginAction
{
    ...
    {
        var configModel = MultiHotkeyActionConfigModel.Deserialize(Configuration);
        ...
        Task.Run(() =>
        {
            if (configModel.SyncButtonState) ActionButton.State = true;
            executing = true;
            ...
            executing = false;
            if (configModel.SyncButtonState) ActionButton.State = false;
        });
