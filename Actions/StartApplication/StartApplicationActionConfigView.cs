using Shlop.WindowsUtilsRevamped.IconUtil;
...
public partial class StartApplicationActionConfigView : ActionConfigControl
{
    ...
    public StartApplicationActionConfigView(PluginAction action)
    {
        ...
        this.method.Items.AddRange(new[] { PluginLanguageManager.PluginStrings.MethodStart,
                                            ...
                                            PluginLanguageManager.PluginStrings.MethodToggleUsingAHK
                                            });
    ...
    private void StartApplicationActionConfigView_Load(object sender, EventArgs e)
    {
        ...
        switch (this._viewModel.StartMethod)
        {
            ...
            case StartMethod.ToggleUsingAHK:
                this.method.Text = PluginLanguageManager.PluginStrings.MethodToggleUsingAHK;
                break;
        }
    ...
    public override bool OnActionSave()
    {
        ...
        else if (this.method.Text.Equals(PluginLanguageManager.PluginStrings.MethodToggleUsingAHK))
        {
            this._viewModel.StartMethod = StartMethod.ToggleUsingAHK;
        }
        ...
        if (!this._viewModel.DeriveAppIcon && buttonEditor != null)
        {
            try
            {
                var iconModel = FileIconImport.ImportIcon(this.path.Text);
                if (iconModel != null)
                {
