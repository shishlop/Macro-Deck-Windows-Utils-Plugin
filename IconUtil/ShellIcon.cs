...
using static Shlop.WindowsUtilsRevamped.IconUtil.ShellIcon;
...
public static class Shell32
{
    ...
    public static extern uint SHGetIDListFromObject([MarshalAs(UnmanagedType.IUnknown)] object iUnknown, out nint ppidl);
...
public static class ShellIcon
{
    ...
    // 256*256
    public static nint GetJumboIcon(int iImage)
    {
